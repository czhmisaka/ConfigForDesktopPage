 ...
 * @LastEditTime: 2024-12-17 22:09:20
...
import DrawerCanvasVue from "./DrawerCanvas.vue";
...
export default defineComponent({
  componentInfo: {
    labelNameCN: "图片蒙版",
    key: "imageSelector",
    description: "通过图片id获取图片，并进行选区",
    gridInfo: { middle: gridSizeMaker(1, 1) },
  } as componentInfo,

  props: ["imageId"],
  components: { DrawerCanvasVue },
  watch: {},
  mounted() {
    this.$emit("ready");
  },
